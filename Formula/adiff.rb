class Adiff < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Newbie012/agent-diff/releases/download/v0.1.0-alpha.99/adiff-darwin-arm64.tar.gz"
      sha256 "6d0f2740977c392176ff0f244e2b514174bcc289db72f7af80c06bc331d0e512"
    end
    on_intel do
      url "https://github.com/Newbie012/agent-diff/releases/download/v0.1.0-alpha.99/adiff-darwin-x64.tar.gz"
      sha256 "64f9cd63d4971fca06938db6e38d5bb687cd28922cfb2444062cd0d0412cd7f3"
    end
  end
