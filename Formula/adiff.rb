class Adiff < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Newbie012/agent-diff/releases/download/v0.1.0-alpha.116/adiff-darwin-arm64.tar.gz"
      sha256 "738009fd7c76639b6286ce27149fcf1d15faab3b081077840cc3c10eaa90559c"
    end
    on_intel do
      url "https://github.com/Newbie012/agent-diff/releases/download/v0.1.0-alpha.116/adiff-darwin-x64.tar.gz"
      sha256 "4f370bb7e23adc215fe9e8101b6e807bed26786712f1d06010d20d82e5dc71cd"
    end
  end
