class Adiff < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Newbie012/agent-diff/releases/download/v0.1.0-alpha.155/adiff-darwin-arm64.tar.gz"
      sha256 "c4e51a2b96fa006e926ed25dd6849ffaf279a3c56f1c0e01fdd354a1f3b94872"
    end
    on_intel do
      url "https://github.com/Newbie012/agent-diff/releases/download/v0.1.0-alpha.155/adiff-darwin-x64.tar.gz"
      sha256 "9ee554f7acd7ca06b629bd3e798de5b21bb76367a40bab5ad31d7cca35eae5bb"
    end
  end
